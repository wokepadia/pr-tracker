...
const slides = [
  ...
  },
  {
    ...
    body:
      "Use a read-only GitHub token scoped to the repositories you choose. The saved token is stored in the operating system keychain.",
    facts: [
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
                  The token is saved in the operating system keychain and is not
                  returned after saving. Repository settings are stored in local
                  app config.
                </p>
              </div>
            </div>
    ...
    return (
      <Card className="rounded-md border-border p-5 shadow-none">
        ...
        <div className="mt-5 flex flex-col gap-4 text-sm">
          <BoundaryRow icon={KeyRound} label="GitHub token" value="OS keychain" />
...
function SetupReferencePanel({
  ...
  const storageLabel =
    storage === "macos-keychain" ? "macOS Keychain" : "OS keychain"
